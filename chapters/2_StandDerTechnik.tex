...
\begin{savenotes}
  \begin{figure}[H] 
    ...
    \caption{\ac{SoS}}\label{fig:sos}
  \end{figure}
\end{savenotes}

\ac{SoS} ist beliebig skalierbar, das ermöglicht auch mehrere Scrum of Scrum Teams, wie in Abbildung~\ref{fig:sos} abgebildet.
...
\begin{savenotes}
  \begin{figure}[H] 
    ...
    \caption[\ac{LeSS} Framework]{\ac{LeSS} Framework~\footcite[][]{less}}\label{fig:less}
  \end{figure}
\end{savenotes}

\subsubsection[Scrum at Scale]{Scrum at Scale~\footcite[vgl.][]{scale}}

Scrum at Scale ist ein
