...
Dann wird genauer auf die Architektur der Software und deren Entwicklung eingegeangen.
...
Um eine Vorauswahl an Metriken treffen zu können, wurden alle bisherigen Retrospektiven analysiert und eine Topliste von Schlagwörtern der folgenden Fragestellungen aus den Retrospektiven erstellt:
\begin{enumerate}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{GQM\mbox{-}Modell \mbox{-} Ablenkung der Entwicklerinnen}\label{tab:gqm-distraction}
\end{table}
