...
Das absolute Issue Volume hat sich in den drei Sprints des Testzweitraums kontinuierlich verkleinert, wie in Abbildung~\ref{fig:eval_issue_volume_total}.
Trotzdem zeigt Abbildung~\ref{fig:eval_issue_volume}, dass bei jedem Sprint immer wieder neue Aufgaben in zum Sprint Backlog während des Sprints hinzugefügt wurden.
