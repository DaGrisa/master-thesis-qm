...
\usepackage{pdfpages}
%\usepackage[width=216mm,height=303mm,center,cam,noinfo]{crop} % Schnittmarken
...
\usepackage[linktocpage=true,pdftex,pdfauthor={Griesser, Daniel},pdftitle={Agile Metriken: Qualitätssicherung in agilen Teams},pdfkeywords={Fachhochschule Vorarlberg~: Masterarbeit~: ITM~: 2018~: Felderer, Michael}]{hyperref} % Links z. B. \href{https://www.wikibooks.org}{Wikibooks home}
...
\input{chapters/0_Praeambel.tex}
\input{chapters/0_Kurzreferat.tex}
...
\input{chapters/2_StandDerTechnik.tex}
\input{chapters/3_Vorgehensweise.tex}
\input{chapters/4_Umsetzung.tex}
\input{chapters/5_Evaluierung.tex}
\input{chapters/6_Schlussfolgerungen.tex}
\input{chapters/7_Zusammenfassung.tex}
