...
\clearpage
\phantomsection\addcontentsline{toc}{chapter}{[evtl. Abkürzungsverzeichnis]}  % evtl. ersetzen durch \addcontentsline{toc}{chapter}{Abkürzungsverzeichnis}
...
\input{chapters/2_Situationsanalyse.tex}
\input{chapters/3_Zielsetzung.tex}
\input{chapters/4_Methodik.tex}
\input{chapters/5_Ergebnisse.tex}
